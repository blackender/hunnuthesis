...
制图制表的更多范例，请见 \href{https://github.com/blackender/hunnuthesis/wiki}{hunnuthesis 知识小站} 和 \href{https://en.wikibooks.org/wiki/LaTeX/Tables}{WiKibook Tables}。
...
\begin{enumerate}
    \item 模板每次发布前，都已在Windows，Linux，MacOS系统上测试通过。下载模板后，若编译出现错误，则请见 \href{https://github.com/blackender/hunnuthesis/wiki}{hunnuthesis知识小站} 的 \href{https://github.com/blackender/hunnuthesis/wiki/%E7%BC%96%E8%AF%91%E6%8C%87%E5%8D%97}{编译指南}。
